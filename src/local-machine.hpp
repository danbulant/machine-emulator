...
private:
    ...
    std::vector<std::vector<uint8_t>> do_take_network_packets() override;
    bool do_push_network_packet(const uint8_t *data, uint32_t length) override;
    void do_clear_network_packets() override;
